...
const styles = ScaledSheet.create({
  ...
  titleWrapper: { flex: 1, marginHorizontal: 30, marginTop: 55, marginBottom: 30, justifyContent: "center" },
  font14: {
    color: "white",
  ...
  mainWrapper: { flex: 1, marginHorizontal: 30, marginBottom: 30, gap: 10 },
  flexRow: { gap: 10, flexDirection: "row", justifyContent: "center" },
  flexRowGap5: { flexDirection: "row", alignItems: "flex-end", flex: 1, gap: 5 },
});
